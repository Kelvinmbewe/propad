...
const links = [
  ...
  },
  {
    ...
    label: "Verifications",
    roles: ["ADMIN", "VERIFIER", "MODERATOR", "AGENT", "LANDLORD"] as Role[],
    icon: <ShieldCheck className="h-4 w-4" />,
  },
  {
    href: "/dashboard/site-visits",
    label: "Site Visits",
    roles: ["ADMIN", "MODERATOR"] as Role[],
  ...
  },
  {
    ...
    label: "Wallet",
    roles: ["USER", "AGENT", "LANDLORD"] as Role[],
    icon: <Wallet2 className="h-4 w-4" />,
  },
  {
    href: "/dashboard/advertiser",
    label: "Advertising",
    roles: ["ADMIN", "ADVERTISER", "LANDLORD"] as Role[],
    icon: <BarChart3 className="h-4 w-4" />,
  },
  {
  ...
  },
  {
    ...
    label: "Payouts",
    roles: ["AGENT", "LANDLORD", "INDEPENDENT_AGENT"] as Role[],
    icon: <Wallet2 className="h-4 w-4" />,
  },
  {
    href: "/dashboard/admin/payouts",
    ...
    <nav className="flex h-full flex-col gap-6">
      <div className="rounded-2xl border border-[color:var(--aurora-color-border)] bg-[color:var(--aurora-color-highest)] p-4 text-[color:var(--aurora-color-text)] shadow-aurora">
        <div className="flex items-center justify-between">
          <p className="text-xs font-semibold uppercase tracking-[0.18em] text-[color:var(--aurora-color-text-subtle)]">
            Workspace
          </p>
          <NotificationsBell />
        </div>
