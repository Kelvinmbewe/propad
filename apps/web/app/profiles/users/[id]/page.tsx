...
export async function generateMetadata({ params }: { params: { id: string } }): Promise<Metadata> {
    ...
    return {
        title: `${profile.name} - ${profile.roles?.[0] || 'User'} Profile | ProPad`,
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div className="md:col-span-2 space-y-6">
                        ...
                        {profile.recentReviews?.length > 0 ? (
                            ...
                            <div className="bg-white p-8 rounded-xl border border-slate-100 text-center">
                                ...
                                <p className="text-sm text-slate-500">This user hasn't received any public reviews yet.</p>
                            </div>
                        )}
                    </div>
                    ...
                    <div className="space-y-6">
                        <div className="bg-white p-6 rounded-xl border border-slate-100 shadow-sm">
                            <h3 className="font-bold text-slate-900 mb-4">Verified Listings</h3>
