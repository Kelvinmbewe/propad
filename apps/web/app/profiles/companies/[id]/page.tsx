              ...
              <div className="md:col-span-4 space-y-4">
                <div className="bg-slate-50 rounded-xl p-6 border border-slate-100">
                  ...
                  <p className="text-xs text-slate-500 mt-3 leading-relaxed">
                    This score is based on verified transactions, client
                    reviews, and years of operation.
                  </p>
                </div>
                <KycSubmissionPanel
                  ownerType="AGENCY"
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6">
            {profile.agents?.map((agent: any) => (
              <a
                ...
                key={agent.id}
                className="group block bg-white rounded-xl border border-slate-100 p-4 hover:shadow-md transition"
              >
