...
export class SiteVisitsController {
  ...
  async assignModerator(
    ...
    return this.siteVisitsService.assignModerator(
      id,
      dto.moderatorId,
      req.user.userId,
    );
  ...
  async completeVisit(
    ...
    return this.siteVisitsService.completeVisit(
      id,
      req.user.userId,
      dto.gpsLat,
      dto.gpsLng,
  ...
  async declineVisit(
    @Param("id") id: string,
    @Body() dto: DeclineSiteVisitDto,
    @Req() req: AuthenticatedRequest,
  ) {
    return this.siteVisitsService.declineVisit(id, req.user.userId, dto.reason);
  }
}
