...
export class MessagingController {
    ...
    @Post('conversations')
    createConversation(@User('id') userId: string, @Body() dto: CreateConversationDto) {
        return this.conversationsService.create(userId, dto);
    }

    @Get('conversations')
    getMyConversations(@User('id') userId: string) {
    ...
    getMessages(
        ...
        return this.messagesService.getMessages(id, userId, Number(limit || 50), cursor);
    }
}
