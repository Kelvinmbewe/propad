import { z } from "zod";
import { CurrencyEnum } from "@propad/config";
...
export const billingConfigSchema = z.object({
  ...
  labels: z.object({
    ...
    receiptTitle: z.string().min(1),
    taxLabel: z.string().min(1),
  }),
  currency: z.object({
    defaultCurrency: z.enum([CurrencyEnum.USD, CurrencyEnum.ZWG]),
    supportedCurrencies: z
      .array(z.enum([CurrencyEnum.USD, CurrencyEnum.ZWG]))
      .min(1),
    allowManualFxRates: z.boolean(),
    fxBase: z.enum([CurrencyEnum.USD, CurrencyEnum.ZWG]),
  }),
});
...
export const defaultAppConfig: AppConfig = {
  ...
  billing: {
    ...
    currency: {
      ...
      supportedCurrencies: [CurrencyEnum.USD, CurrencyEnum.ZWG],
      allowManualFxRates: true,
      fxBase: CurrencyEnum.USD,
    },
  },
};
