...
declare module '@prisma/client' {
    ...
    export const ReferralSource: {
        ...
        readonly AGENT_SIGNUP: 'AGENT_SIGNUP';
        readonly ADVERTISER_SIGNUP: 'ADVERTISER_SIGNUP';
    };
    export type ReferralSource = 'USER_SIGNUP' | 'AGENT_SIGNUP' | 'ADVERTISER_SIGNUP';
    ...
    export class PrismaClient implements PrismaClientEventEmitter {
        ...
        $transaction<T = any>(fn: (client: any) => Promise<T>, options?: Record<string, any>): Promise<T>;
    ...
    export type ReferralCode = Record<string, any>;
}
